...
%Initial conditions vector
    ...
    x1_3_diphosphosphoglycerate=0.008;
    x3_Phosphoglycerate=2.13;
    x2_Phosphoglycerate=0.399;
    Ribulose_5_phosphate=0.111;
	x0(1) = Phosphoenol_pyruvate;
	x0(2) = Extracellular_Glucose;
	x0(3) = Glucose_6_Phosphate;
	x0(4) = Pyruvate;
	x0(5) = Fructose_6_Phosphate;
	x0(6) = Glucose_1_Phosphate;
	x0(7) = x6_Phosphogluconate;
	x0(8) = Fructose_1_6_bisphosphate;
	x0(9) = sedoheptulose_7_phosphate;
	x0(10) = Glyceraldehyde_3_Phosphate;
	x0(11) = Erythrose_4_phosphate;
	x0(12) = Xylulose_5_phosphate;
	x0(13) = Ribose_5_phosphate;
	x0(14) = Dihydroxyacetonephosphate;
	x0(15) = x1_3_diphosphosphoglycerate;
	x0(16) = x3_Phosphoglycerate;
	x0(17) = x2_Phosphoglycerate;
	x0(18) = Ribulose_5_phosphate;
